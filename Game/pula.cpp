...
/**
 * Метод Move()
 * @brief Отвчечает за движение пули
 * Проверка пути пули
 * Перемещение пули по координате x
 * Перемещение пули по координате y
 *  Передача области функции
 *  Проверка на столкновение с препятсвием
 *  Взаимодействие с танком
 *  Если попали, возвращаем танк на спавн
 *
 */
//Движение пули.
void Tpula::Move()
